...
def lstm_pred_hierarchical(mydata, modelname, seed, hidden_size, dens2_size):
    # for seed in seeds:
    ...
    model.add(Dense(obj_number, activation='sigmoid'))
    ...
    mc = ModelCheckpoint(modelname.format(seed), monitor='val_binary_accuracy', mode='max', verbose=1,
                         save_best_only=True)
